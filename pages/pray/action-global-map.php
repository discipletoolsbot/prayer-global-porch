            ...
            <div id="map-wrapper">
                ...
                <div id="foot_block">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-sm-6 col-md-2 center"><strong>Your Recent Prayers</strong><br><img class="three-em" style="padding-top:5px;" src="<?php echo esc_url( plugin_dir_url( __DIR__ ) . 'assets/images/black-check-50.png' ) ?>" /></div>
                        <div class="col col-sm-1 col-md-1 center">
