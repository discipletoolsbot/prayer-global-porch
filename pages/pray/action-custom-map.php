...
class PG_Custom_Prayer_App_Map extends PG_Custom_Prayer_App {
    ...
    public function header_javascript(){
        ...
        <script src="<?php echo esc_url( trailingslashit( plugin_dir_url( __DIR__ ) ) ) ?>assets/js/share.js?ver=<?php echo esc_attr( fileatime( trailingslashit( plugin_dir_path( __FILE__ ) ) . 'assets/js/share.js' ) ) ?>"></script>
        <?php
    }
