            ...
            <div id="map-wrapper">
                ...
                <div id="foot_block">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-6 col-sm-3 center d-none d-sm-block"><strong>Places Remaining</strong><br><strong><span class="one-em red-bg stats-figure remaining"></span></strong></div>
                        <div class="col col-6 col-sm-3 center d-none d-sm-block"><strong>Places Covered</strong><br><strong><span class="one-em green-bg stats-figure completed"></span></strong></div>
